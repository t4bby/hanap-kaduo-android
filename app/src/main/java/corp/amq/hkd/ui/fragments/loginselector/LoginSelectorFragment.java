...
public class LoginSelectorFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.loginSelectorBtn.setOnClickListener(v ->
                Navigation.findNavController(v).navigate(R.id.action_loginSelectorFragment_to_loginFragment));
        binding.registerSelectorBtn.setOnClickListener(v ->
                Navigation.findNavController(v).navigate(R.id.action_loginSelectorFragment_to_registrationFragment));
    }
